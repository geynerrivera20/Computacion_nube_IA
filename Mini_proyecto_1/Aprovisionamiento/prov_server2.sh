...
echo 'Configurando archivo index.js'
#sed -i 's/const HOST='192.168.100.3';/const HOST='192.168.100.3';' /home/vagrant/consulService/app/index.js
sed -i 's/const HOST='192.168.100.3';/const HOST='192.168.100.4';/g' /home/vagrant/consulService/app/index.js
#sed -i 's/const HOST='192.168.100.3';/const HOST='192.168.100.5';' /home/vagrant/consulService/app/index.js
sudo mv /vagrant/index2.js /home/vagrant/consulService/app/index.js
